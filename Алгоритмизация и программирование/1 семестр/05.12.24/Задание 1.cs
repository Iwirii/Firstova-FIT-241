//Необходимо создать массив, состоящий из объектов, характеризующих ученика класса. 
//В объекте будут следующие поля: ФИО, год рождения, ФИО мамы, ФИО папы, адрес (улица, дом и квартира). 
//Необходимо реализовать методы (конструкторы) по заполнению, по изменению, по поиску всех учеников начинающихся на заданный символ, 
//поиск всех учеников проживающих на заданной улице. (предусмотреть возможность не заполнять поля одного из родителя или двух)
//В головной программе будет меню, которое позволяет выбрать или заполнение или модификацию или выборку по одному запросу, либо по другому запросу, выход
//Модификация данных будет проводиться по ФИО ребенка
//Выборку по году рождения
